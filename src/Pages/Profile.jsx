...
import { updateUserProfileAsync } from "../components/auth/authSlice";
// import { updateUserProfileImageAsync } from "../components/auth/authSlice";
function Profile() {
  ...
  return (
    <div className="grid grid-cols-1 gap-x-8 lg:grid-cols-5 max-w-7xl mx-auto m-2">
      ...
      <div className=" md:block hidden lg:col-span-2 p-2">
        <span className="text-center text-lg font-semibold">Profile Image</span>
        <img
          src={login_img}
          alt="login-image"
